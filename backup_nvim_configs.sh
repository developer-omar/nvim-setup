...
if [ -d "$NVIM_LOCAL_SHARE_DIR" ]; then
    ...
    mv "$NVIM_LOCAL_SHARE_DIR" "$NVIM_LOCAL_SHARE_DIR.backup"  
else
...
if [ -d "$NVIM_LOCAL_STATE_DIR" ]; then
    ...
    mv  "$NVIM_LOCAL_STATE_DIR" "$NVIM_LOCAL_STATE_DIR.backup"
else
...
if [ -d "$NVIM_LOCAL_CACHE_DIR" ]; then
    ...
    mv  "$NVIM_LOCAL_CACHE_DIR" "$NVIM_LOCAL_CACHE_DIR.backup"
else
